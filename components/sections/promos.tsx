    ...
    <section className="overflow-hidden bg-amber text-deep">
      <Reveal className="mx-auto grid max-w-[1600px] lg:grid-cols-[1fr_auto]">
        <div className="px-5 py-16 sm:px-10 lg:px-20 lg:py-20">
          ...
          <p className="mt-5 text-base text-deep">Entre no grupo de promoções da La Fontilla no WhatsApp.</p>
        </div>
        <div className="flex border-t border-deep/20 p-4 sm:p-5 lg:w-[24rem] lg:border-l lg:border-t-0">
          ...
          >
            ...
            <Sparkles aria-hidden="true" className="absolute left-7 top-8 size-5 -translate-y-2 text-amber opacity-0 transition-[opacity,transform] delay-100 duration-500 group-hover:translate-y-0 group-hover:opacity-100 group-focus-visible:translate-y-0 group-focus-visible:opacity-100" />
            <Sparkles aria-hidden="true" className="absolute right-8 top-12 size-4 translate-y-2 text-cream opacity-0 transition-[opacity,transform] delay-200 duration-500 group-hover:translate-y-0 group-hover:opacity-80 group-focus-visible:translate-y-0 group-focus-visible:opacity-80" />
